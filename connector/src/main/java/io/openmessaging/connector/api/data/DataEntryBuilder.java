...
public class DataEntryBuilder {
  ...
  public SourceDataEntry buildSourceDataEntry(
      ByteBuffer sourcePartition, ByteBuffer sourcePosition) {

    return new SourceDataEntry(
        sourcePartition, sourcePosition, timestamp, entryType, queueName, schema, payload);
  }
  ...
  private Field lookupField(String fieldName) {
    ...
    if (field == null) throw new RuntimeException(fieldName + " is not a valid field name");
    return field;
  }
}
