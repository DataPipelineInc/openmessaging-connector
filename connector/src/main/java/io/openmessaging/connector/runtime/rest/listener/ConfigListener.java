...
/**
 * This listener synchronizes to update ConfigStorageService. If we do something with config or
 * target state, that listener will ensure that we get the latest modified snapshot.
 */
