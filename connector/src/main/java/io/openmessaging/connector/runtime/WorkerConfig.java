...
public class WorkerConfig {
  ...
  public static final String POSITION_COMMIT_INTERVAL_MS_CONFIG =
      "position.commit.interval.ms.config";
  public static final String POSITION_COMMIT_TIMEOUT_MS_CONFIG =
